import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as e}from"./app-64319cf9.js";const p={},t=e(`<h1 id="webpack配置汇总" tabindex="-1"><a class="header-anchor" href="#webpack配置汇总" aria-hidden="true">#</a> Webpack配置汇总</h1><p>看完了《Webpack实战：入门、进阶与调优》(第2版)把书里提到的基本内容都罗列到了一个配置文件中方便复习，为了显示效果，重复的配置项没有注释掉</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token punctuation">{</span> webpack <span class="token punctuation">}</span> <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;webpack&#39;</span><span class="token punctuation">)</span>
